...
function Notification(props: { text: string }) {
  const { text } = props;
  return (
    <div
      id="toast-success"
      ...
      role="alert"
    >
      <div className="inline-flex items-center justify-center flex-shrink-0 w-8 h-8 text-white bg-green-700 rounded-lg dark:bg-green-800 dark:text-green-200">
